...
if (!empty($_POST)) {
    ...
    $url = $GLOBALS['server_ip'] . "/login?username=$username&password=$password";
    ...
    if ($result['code'] == '200' || $result['code'] == '220'){
        $redirect = "account.php?username=".$username;
...
<?php
            ...
            <div class="col-10 offset-1">
                <input type="submit" id="submit" class="btn btn-block" value="Login">
            </div>
        </form>
        <span>No Account Yet? <a href="signup.php">Sign Up!</a></span>
    </div>
</div>
